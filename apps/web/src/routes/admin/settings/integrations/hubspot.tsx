    ...
    <div className="space-y-6">
      ...
      {integration && (isConnected || isPaused) && (
        <div className="rounded-xl border border-green-500/20 bg-green-500/5 p-6 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-foreground">{m.integration_hubspot_active_message()}</p>
          </div>
        </div>
      )}
      ...
      {!integration && (
        <IntegrationSetupCard
          ...
          title={m.integration_hubspot_title()}
          description={m.integration_hubspot_description()}
          steps={[
            <p key="1">{m.integration_hubspot_setup_step_1()}</p>,
            <p key="2">{m.integration_hubspot_setup_step_2()}</p>,
            <p key="3">{m.integration_hubspot_setup_step_3()}</p>,
          ]}
          connectionForm={
